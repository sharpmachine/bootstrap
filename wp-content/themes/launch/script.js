...
/*-----------------------------------------------------------------------------------*/
/*	Backstretch - v2.0.1 - http://srobbin.com/jquery-plugins/backstretch/
/*-----------------------------------------------------------------------------------*/
...
jQuery(document).ready(function($) {
    $(".slide").click(function(){
        ...
        $(myelement).fadeTo("slow", 1.0, function() {
            $(".panel:visible").not(myelement).hide();
    ...
    $('div.panel').css({'height':(($(document).height()))+'px'});
    
    $('nav li a').attr('href', function(i) {
       return '#panel-' + i;
    });
    
    $('body .panel').attr('id', function(i) {
       return 'panel-' + i;
    });
});